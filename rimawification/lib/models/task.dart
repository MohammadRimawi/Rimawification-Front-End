...
class Todo_obj {
  ...
  static Future<Map<String, dynamic>> loadTask(int task_id) async {
    final response = await http.post(
        Uri.parse('http://rimawi.me:5050/api/get/task/' + task_id.toString()));
...
class Task_obj {
  ...
  static Future<List<Task_obj>> loadTasks() async {
    All_Tasks = [];
    final response =
